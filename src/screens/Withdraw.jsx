...
import { fetchWithdraw, withdraws } from '../store/action/userAppStorage';
...
function Withdraw() {
    ...
    let fetchWithdraws = async () => {
        setIsLoading(true)
        let res = await dispatch(fetchWithdraw())
        if (!res.bool) {
            setIsLoading(false)
            return
        }
        setIsWithdraw(res.message)
        setIsLoading(false)
    }
    ...
    let submitHandler = async (e) => {
        ...
        setIsWithdraw(prev => [...prev, res.message])
        setAmount('')
        setIsLoading(false)
        setIsUrl(res.url)
    }
    ...
    return (<>
        ...
        <div className={styles.screenContainer}>
            ...
            <div className={styles.maindashboard} style={{ height: '100vh' }} >
                <Header home={false} title={'Withdraw Fund'} />
                ...
                <div className={styles.mainscreen}>
                    ...
                    <div className={styles.mainscreenright}>
                        ...
                        <form className={styles.form} onSubmit={submitHandler}>
                            <h4 className={styles.headsection}>Withdraw fund</h4>
